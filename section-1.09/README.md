This folder contains two different practicals, for us to use depending on (i) the time we have available, and (ii) the extent to which you want to explore the details of KMeans Clustering:
